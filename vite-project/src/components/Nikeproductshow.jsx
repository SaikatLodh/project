...
const Nikeproductshow = () => {
    const context = useContext(MyContext)
const {getnike} = context
  ...
  return (
    ...
    <div className='pb-[100px]'>
        <div className='text-center pt-[100px]'>
            <h2 className='text-[50px] text-[black]'>Nike Shoes</h2>
        </div>
                        ...
                        <div className='w-full h-[500px] relative' >
                            ...
                            <div className='w-[14%] absolute z-20 right-4 top-0'>
                                <div className='flex items-center justify-end gap-2 p-5'>
                                    <div>{getnike.id ? <><FaHeart className='text-[25px] cursor-pointer' /></> : <><CiHeart onClick={() => wishlistCart(item)} className='text-[25px] cursor-pointer' /></>}</div>
...
export default Nikeproductshow
