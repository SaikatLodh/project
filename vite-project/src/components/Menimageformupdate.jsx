...
const Menimageformupdate = () => {
    const context = useContext(myContext)
    const {menImage,setmenimge,updatemenimage,} = context
  return (
    <div>
    <div>
   <div>
...
<button className='w-[200px] h-[40px] rounded-xl bg-[black] text-[white]' onClick={updatemenimage}>Send</button>
...
export default Menimageformupdate
