...
const SportsShoesFrom = () => {
    const context = useContext(myContext);
    const {sportsProducts,setSportsProducts,sportsAddProduct} = context
  return (
    <div>
        <div>
...
<div className='pb-10'><input type="text" name="imageUrlThree" id="name" placeholder='Product Image Four' className=' border-b-2 border-black w-full pb-3' value={sportsProducts.imageUrlFour} onChange={(e) => setSportsProducts({ ...sportsProducts, imageUrlFour: e.target.value })}/></div>
...
<div className='text-center'>
    ...
    <div><button className='w-[200px] h-[40px] rounded-xl bg-[black] text-[white]' onClick={sportsAddProduct}>Send</button></div>
...
export default SportsShoesFrom
